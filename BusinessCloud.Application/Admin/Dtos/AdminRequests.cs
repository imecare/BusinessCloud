...
/// <summary>Datos de la suscripci贸n al crear/actualizar una empresa.</summary>
...
/// <summary>Alta de una empresa: crea el tenant, sus m贸dulos, el usuario SuperAdmin y, opcionalmente, la suscripci贸n.</summary>
...
/// <summary>Activaci贸n/suspensi贸n de una empresa.</summary>
public class SetCompanyStatusRequest
{
    public bool IsActive { get; set; }
}

/// <summary>Actualizaci髇 del correo de acceso del SuperAdmin de una empresa.</summary>
public class UpdateCompanyAdminEmailRequest
{
    public string AdminEmail { get; set; } = null!;
}
/// <summary>Alta/edici贸n de un comisionista del SaaS.</summary>
...
/// <summary>Alta/edici贸n de un paquete del cat谩logo.</summary>
