...
public record UpdateBzaCustomerCommand : IRequest
{
    ...
    /// <summary>
    /// Cuando es true, el cliente no tiene n̼mero de WhatsApp: se ignora <see cref="Phone"/>
    /// y se conserva/asigna un n̼mero placeholder. Al desmarcarlo y capturar el tel̩fono
